...
Please refer the COEN 241 - HW #3 Report.pdf for all the answers with appropriate screenshots.
Also find the code for binary_tree.py (Mininet) and of_tutorial.py (POX)
